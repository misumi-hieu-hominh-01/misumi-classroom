...
import { PlayerData, PlayerPosition, PlayerRotation, RoomData } from '../common/types/multiplayer.types'
...
export class MultiplayerService {
	...
	cleanupInactivePlayers(maxInactiveTime: number = 300000): void { // 5 minutes
		const now = Date.now()
	...
	getRoomStats(): { roomId: string; playerCount: number; lastActivity: Date }[] {
